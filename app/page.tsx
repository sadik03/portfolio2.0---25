        ...
        <div className="container relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="flex gap-4 pt-4">
              <Link href="https://github.com/sadik03" target="_blank" rel="noopener noreferrer">
                <Button
                  variant="ghost"
                  size="icon"
              ...
              <Link href="https://www.linkedin.com/in/sadik-md03/" target="_blank" rel="noopener noreferrer">
                <Button
                  variant="ghost"
                  size="icon"
                  className="rounded-full bg-zinc-800/50 hover:bg-zinc-800 text-zinc-400 hover:text-white"
              ...
              <Link href="mailto:sksadik240@gmail.com">
                <Button
                  variant="ghost"
                  size="icon"
                  className="rounded-full bg-zinc-800/50 hover:bg-zinc-800 text-zinc-400 hover:text-white"
              ...
              <GlassmorphicCard>
                ...
                <div className="grid grid-cols-2 gap-4 mt-8">
                  <div className="space-y-1">
                    ...
                    <div className="font-medium">Md Sadik</div>
                  </div>
                  <div className="space-y-1">
                    <div className="text-sm text-zinc-500">Email</div>
                    <div className="font-medium">sksadik240@gmail.com</div>
                  </div>
                  <div className="space-y-1">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="font-medium">linkedin.com/in/sadik</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-zinc-800 flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <div className="font-medium">github.com/sadik03</div>
                  </div>
                </div>
              </div>
        ...
        <div className="container flex flex-col md:flex-row justify-between items-center gap-6">
          <div>
            <Link href="/" className="font-bold text-xl">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-600">Sadik</span>
